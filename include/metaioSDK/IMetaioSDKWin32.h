...
namespace metaio
{
/** \brief The interface to Unifeye Mobile on Win32
*
 ...
 * \param windowHandle depending on plattform, this may be an instace
 *	to a window. See the example of each platfrom for best usage.
